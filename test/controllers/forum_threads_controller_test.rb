...
class ForumThreadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum_thread" do
    assert_difference("ForumThread.count") do
      post forum_threads_url, params: { forum_thread: { admin_user_id: @forum_thread.admin_user_id, forum_forum_id: @forum_thread.forum_forum_id, forum_subforum_id: @forum_thread.forum_subforum_id, name: @forum_thread.name } }
    end
  ...
  test "should update forum_thread" do
    patch forum_thread_url(@forum_thread), params: { forum_thread: { admin_user_id: @forum_thread.admin_user_id, forum_forum_id: @forum_thread.forum_forum_id, forum_subforum_id: @forum_thread.forum_subforum_id, name: @forum_thread.name } }
